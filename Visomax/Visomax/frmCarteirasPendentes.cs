...
namespace Visomax
{
    public partial class frmCarteirasPendentes : Form
    {
        SqlConnection conn = new SqlConnection(Properties.Settings.Default.S8_RealConnectionString);
        String RelatorioTitulo = "Relação de Carteiras Pendentes - ";
        int paginaAtual = 1;
        static int li = 0;
        public frmCarteirasPendentes()
        {
            InitializeComponent();
        }

        private void frmCarteirasPendentes_Load(object sender, EventArgs e)
        {
            try
            {
                SqlCommand caixa = new SqlCommand("select "+                                                           
                    ...
                    "where "+                                                    
                    "contas_receber.tipo = 'R' and "+                        
                    "contas_receber.tipo_parcelamento = 'C' and "+           
        ...
        private void pdRelatorios_PrintPage(System.Object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Código: ", FonteNegrito, Brushes.Black, MargemEsq + 240, PosicaoDaLinha);
            e.Graphics.DrawString("Cliente: ", FonteNegrito, Brushes.Black, MargemEsq + 320, PosicaoDaLinha);
            e.Graphics.DrawString("Emissão ", FonteNegrito, Brushes.Black, MargemEsq + 480, PosicaoDaLinha);
            e.Graphics.DrawString("Vencimento: ", FonteNegrito, Brushes.Black, MargemEsq + 560, PosicaoDaLinha);
            ...
            while ((LinhaAtual < LinhasPorPagina && registros > li))
            {
                ...
                e.Graphics.DrawString(codigo, FonteNormal, Brushes.Black, MargemEsq + 240, PosicaoDaLinha + 15);
                ...
                while (cliente.Length > 0)
                {
                    ...
                    e.Graphics.DrawString(cliente.Substring(0, cara), FonteNormal, Brushes.Black, MargemEsq + 320, y);
                    y = y + 20;
                    break;

                }
                // e.Graphics.DrawString(cliente, FonteNormal, Brushes.Black, MargemEsq + 320, PosicaoDaLinha + 15);
                e.Graphics.DrawString(emissao, FonteNormal, Brushes.Black, MargemEsq + 480, PosicaoDaLinha + 15);
                e.Graphics.DrawString(vencimento, FonteNormal, Brushes.Black, MargemEsq + 560, PosicaoDaLinha + 15);
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            {
                RelatorioTitulo = "Consulta de Carteiras Pendentes - ";
